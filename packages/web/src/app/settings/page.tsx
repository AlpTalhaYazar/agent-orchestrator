    ...
    <DashboardShell projects={projectSummaries} defaultLocation={homedir()}>
      <main className="min-h-screen bg-[var(--color-bg-base)] px-5 py-8 text-[var(--color-text-primary)] sm:px-6 lg:px-10">
        <div className="mx-auto max-w-[1120px]">
          <header className="rounded-[24px] border border-[var(--color-border-default)] bg-[var(--color-bg-surface)] px-6 py-6 shadow-[0_18px_50px_rgba(0,0,0,0.08)]">
          ...
          <div className="mt-6 grid gap-6 xl:grid-cols-[minmax(0,1.2fr)_minmax(320px,0.8fr)]">
            <div className="space-y-6">
              <section id="preferences" className="rounded-[24px] border border-[var(--color-border-default)] bg-[var(--color-bg-surface)] px-6 py-6 shadow-[0_12px_34px_rgba(0,0,0,0.05)]">
                <PreferenceSettings
              ...
              <section id="projects" className="rounded-[24px] border border-[var(--color-border-default)] bg-[var(--color-bg-surface)] px-6 py-6 shadow-[0_12px_34px_rgba(0,0,0,0.05)]">
                <ProjectSettings
            ...
            <div className="space-y-6">
              <section id="agents" className="rounded-[24px] border border-[var(--color-border-default)] bg-[var(--color-bg-surface)] px-6 py-6 shadow-[0_12px_34px_rgba(0,0,0,0.05)]">
                <AgentSettings
              ...
              <section id="integrations" className="rounded-[24px] border border-[var(--color-border-default)] bg-[var(--color-bg-surface)] px-6 py-6 shadow-[0_12px_34px_rgba(0,0,0,0.05)]">
                <IntegrationSettings />
              </section>
            </div>
          </div>
